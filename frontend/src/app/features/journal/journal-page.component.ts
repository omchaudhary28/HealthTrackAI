    ...
    <section appScrollReveal class="page-stack">
      ...
      <div class="mt-card mt-card-hover p-5 sm:p-6">
        ...
        <div class="mt-5 grid gap-3">
          <ng-container *ngIf="entries$ | async as entries; else loading">
            <div *ngIf="!entries.length" class="mt-card-soft px-4 py-4 text-sm text-slate-600">
              <div class="comic-empty-state">
                ...
                <div>
                  <div class="font-semibold text-slate-700">No entries yet.</div>
                  <div class="mt-1 text-sm text-slate-600">One line is enough to get started.</div>
                </div>
              </div>
            </div>
          ...
          <ng-template #loading>
            <div class="mt-card-soft px-4 py-4 text-sm text-slate-600">
              <div class="comic-empty-state">
                <div class="comic-empty-illustration"></div>

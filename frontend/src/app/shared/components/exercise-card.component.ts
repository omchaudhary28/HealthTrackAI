...
@Component({
  ...
  template: `
    <article class="group rounded-2xl border border-slate-200/70 bg-white/80 p-6 shadow-sm backdrop-blur transition-all duration-200 hover:-translate-y-0.5 hover:scale-[1.01] hover:shadow-lg active:scale-[0.99]">
      ...
      <p class="mt-2 text-sm leading-7 text-slate-600">{{ exercise.description }}</p>
